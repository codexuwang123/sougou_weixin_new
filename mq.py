...
class RabbitMQClient:
    ...
    __default_routing_key = "crawler_163_key"
    __default_DeadLetterExchange = "crawler_163_exchange"
    __default_DeadLetterQueue = "crawler_163_queue"

    def __init__(self, username='wangxu', password='wangxu', host='', port=''):
        self.host = str(host)
        self.port = int(port)
    ...
    def consume(self, callback, queue, dlx=__default_DeadLetterExchange, dlq=__default_DeadLetterQueue,
        ...
        self.channel.basic_consume(queue=queue, consumer_callback=callback, exclusive=exclusive,
